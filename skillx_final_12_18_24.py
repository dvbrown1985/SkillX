...
# Load the model
print("Loading the model file using joblib...")
loaded_model = load('Streamlit/model_1_6_jobs_roles.joblib')
print("Model loaded.")

# Load the LabelEncoder
print("Loading LabelEncoder using joblib...")
loaded_label_encoder = load('Streamlit/label_encoder_1_6_jobs_roles.joblib')
...
with container1:
    st.image(image, caption="", clamp=False, channels="RGB", use_column_width=True)
