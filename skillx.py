...
expander.write('''
    ...
    The job descriptions, salary info, skill match analysis, skill development recommendations, and skill gaps are developed and output from the Google Gemini LLM.
